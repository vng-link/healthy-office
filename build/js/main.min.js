    ...
    value: function _breakpointChecker() {
      ...
      if (this._breakpointMedia.matches) {
        menuItems.forEach(function (item) {
          var btn = item.querySelector('[data-header-accordion-btn]');
          btn.addEventListener('click', _this._linkClickHandler);
        });
      } else {
        menuItems.forEach(function (item) {
          var btn = item.querySelector('[data-header-accordion-btn]');
          btn.removeEventListener('click', _this._linkClickHandler);
          if (item.classList.contains('is-active')) {
            item.classList.remove('is-active');
          }
        });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initScrollAnimation: function() { return /* binding */ initScrollAnimation; }
/* harmony export */ });
...
var main = document.querySelector('[data-scroll-animation]');
var breakpointMedia = window.matchMedia('(max-width: 807px)');
var timeline = null;
...
var getScrollAnimation = function getScrollAnimation() {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger);
  var parent = main.parentElement;
  var style = window.getComputedStyle(parent);
  var block = main.querySelector('[data-scroll-animation-block]');
  var lenis = new lenis__WEBPACK_IMPORTED_MODULE_2__["default"]();
  var header = document.querySelector("[data-header]");
  var end = document.querySelector('[data-scroll-animation-end]');
  var _raf = function raf(time) {
    lenis.raf(time);
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.update();
  ...
  timeline = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
    scrollTrigger: {
      trigger: main,
      start: "top-=".concat(style.paddingTop, " top"),
...
/* harmony import */ var _modules_init_scroll_animation_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-scroll-animation.js */ "./js/modules/init-scroll-animation.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_init_scroll_animation_js__WEBPACK_IMPORTED_MODULE_9__.initScrollAnimation)();
